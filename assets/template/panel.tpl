<header class="slidePanel-header overlay" style="background-image: url('http://lab.techclever.net/assets/template/global/photos/placeholder.png')">
  <div class="overlay-panel overlay-background vertical-align">
    ...
    <div class="vertical-align-middle">
      <a class="avatar" href="javascript:void(0)">
        <img src="http://lab.techclever.net/assets/template/global/portraits/2.jpg" alt="...">
      </a>
